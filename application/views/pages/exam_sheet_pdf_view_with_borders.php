...
?>
		<div style="height:100% !important;">
			<div style="height:13% !important;border:1px solid black;margin-bottom: 10px;padding-right:10px;padding-left: 10px;"><pre><?php print_r($students); ?></pre></div>
			<div style="height:86% !important;width:99.7%;border:1px solid black;">
<?php 		$i = 0;
