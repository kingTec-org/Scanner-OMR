...
<div class="row wrapper wrapper-content animated fadeInRight">
  <div class="ibox-title">
    <a href="<?php echo base_url('subject/add'); ?>"><button class="btn btn-success btn-outline"> <i class="fa fa-plus"></i> Add Subject</button></a>
  </div>
...
$(document).ready(function() {
  oTable = $('#example').DataTable( {
    "ajax": "<?php echo base_url('subject/get_show_data'); ?>",
    "dom": 'lBftip',
    "buttons": [
...
{ 
  $.ajax({
    type:'POST',
    url: '<?php echo base_url(); ?>'+'subject/view/'+id,
