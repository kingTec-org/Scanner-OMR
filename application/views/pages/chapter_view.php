...
<div class="row wrapper wrapper-content animated fadeInRight">
  <div class="ibox-title">
    <a href="<?php echo base_url('chapter/add'); ?>"><button class="btn btn-success btn-outline"> <i class="fa fa-plus"></i> Add Chapter</button></a>
  </div>
...
$(document).ready(function() {
  oTable = $('#example').DataTable( {
    "ajax": "<?php echo base_url('chapter/get_show_data'); ?>",
    "dom": 'lBftip',
    "buttons": [
