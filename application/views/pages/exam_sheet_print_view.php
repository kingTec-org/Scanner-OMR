...
?>
		<div style="width:99%;page-break-after: always;">
			<div style="border:1px solid black;margin-bottom: 10px;padding-right:10px;padding-left: 10px;"><?php print_r($students); ?></div>
			<div style="width:100%;border:0px solid black;">
<?php 		$i = 0;
			foreach ($data['exam']['z_sections'] as $ks=>$subject_sections) {
?>
				<div style="border-spacing: 0; text-align:center;float:left;border:1px solid black;width: <?php echo 99/$total_subjects; ?>%;<?php echo ($i != 0) ? 'border-left:1px solid black;' : '';?>">
...
<?php 					switch($ssv['z_questions'][0]['qn_type'])
						{
							...
							case 'multiple':
								...
								{
?>
									<div style="border-bottom:1px solid black;float: left;width:<?php echo 100/$count; ?>%">
<?php
									$b = $a + $cnt-1;
									for($c=$a;$c<=$b;$c++)
									{
